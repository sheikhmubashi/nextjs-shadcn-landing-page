...
export const HeroCards = () => {
 return (
  <div className="hidden xl:flex flex-row flex-wrap xl:-gap-6 gap-6 2xl:gap-6 relative w-[700px] h-[500px] mr-10 xl:mr-0">
   {/* Testimonial */}
   <Card className="absolute w-[340px] -top-[15px] drop-shadow-xl shadow-black/10 dark:shadow-white/10">
    <CardHeader className="flex flex-row items-center  gap-4 gap-4 mt-1 pb-2">
     <Avatar>
   ...
   {/* Service */}
   <Card className="absolute xl:w-[350px] right-6 xl:-right-[10px] bottom-[35px]  drop-shadow-xl shadow-black/10 dark:shadow-white/10">
